 ...
 */var pp;function c0(){if(pp)return et;pp=1;var u=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),a=Symbol.for("react.provider"),f=Symbol.for("react.context"),c=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),h=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),g=Symbol.iterator;function x(C){return C===null||typeof C!="object"?null:(C=g&&C[g]||C["@@iterator"],typeof C=="function"?C:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,y={};function _(C,O,Y){this.props=C,this.context=O,this.refs=y,this.updater=Y||S}_.prototype.isReactComponent={},_.prototype.setState=function(C,O){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,O,"setState")},_.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function T(){}T.prototype=_.prototype;function A(C,O,Y){this.props=C,this.context=O,this.refs=y,this.updater=Y||S}var k=A.prototype=new T;k.constructor=A,E(k,_.prototype),k.isPureReactComponent=!0;var L=Array.isArray,b=Object.prototype.hasOwnProperty,F={current:null},j={key:!0,ref:!0,__self:!0,__source:!0};function M(C,O,Y){var de,me={},X=null,xe=null;if(O!=null)for(de in O.ref!==void 0&&(xe=O.ref),O.key!==void 0&&(X=""+O.key),O)b.call(O,de)&&!j.hasOwnProperty(de)&&(me[de]=O[de]);var ye=arguments.length-2;if(ye===1)me.children=Y;else if(1<ye){for(var we=Array(ye),Se=0;Se<ye;Se++)we[Se]=arguments[Se+2];me.children=we}if(C&&C.defaultProps)for(de in ye=C.defaultProps,ye)me[de]===void 0&&(me[de]=ye[de]);return{$$typeof:u,type:C,key:X,ref:xe,props:me,_owner:F.current}}function z(C,O){return{$$typeof:u,type:C.type,key:O,ref:C.ref,props:C.props,_owner:C._owner}}function K(C){return typeof C=="object"&&C!==null&&C.$$typeof===u}function B(C){var O={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(Y){return O[Y]})}var fe=/\/+/g;function se(C,O){return typeof C=="object"&&C!==null&&C.key!=null?B(""+C.key):O.toString(36)}function q(C,O,Y,de,me){var X=typeof C;(X==="undefined"||X==="boolean")&&(C=null);var xe=!1;if(C===null)xe=!0;else switch(X){case"string":case"number":xe=!0;break;case"object":switch(C.$$typeof){case u:case e:xe=!0}}if(xe)return xe=C,me=me(xe),C=de===""?"."+se(xe,0):de,L(me)?(Y="",C!=null&&(Y=C.replace(fe,"$&/")+"/"),q(me,O,Y,"",function(Se){return Se})):me!=null&&(K(me)&&(me=z(me,Y+(!me.key||xe&&xe.key===me.key?"":(""+me.key).replace(fe,"$&/")+"/")+C)),O.push(me)),1;if(xe=0,de=de===""?".":de+":",L(C))for(var ye=0;ye<C.length;ye++){X=C[ye];var we=de+se(X,ye);xe+=q(X,O,Y,we,me)}else if(we=x(C),typeof we=="function")for(C=we.call(C),ye=0;!(X=C.next()).done;)X=X.value,we=de+se(X,ye++),xe+=q(X,O,Y,we,me);else if(X==="object")throw O=String(C),Error("Objects are not valid as a React child (found: "+(O==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":O)+"). If you meant to render a collection of children, use an array instead.");return xe}function ae(C,O,Y){if(C==null)return C;var de=[],me=0;return q(C,de,"","",function(X){return O.call(Y,X,me++)}),de}function ee(C){if(C._status===-1){var O=C._result;O=O(),O.then(function(Y){(C._status===0||C._status===-1)&&(C._status=1,C._result=Y)},function(Y){(C._status===0||C._status===-1)&&(C._status=2,C._result=Y)}),C._status===-1&&(C._status=0,C._result=O)}if(C._status===1)return C._result.default;throw C._result}var te={current:null},G={transition:null},W={ReactCurrentDispatcher:te,ReactCurrentBatchConfig:G,ReactCurrentOwner:F};function V(){throw Error("act(...) is not supported in production builds of React.")}return et.Children={map:ae,forEach:function(C,O,Y){ae(C,function(){O.apply(this,arguments)},Y)},count:function(C){var O=0;return ae(C,function(){O++}),O},toArray:function(C){return ae(C,function(O){return O})||[]},only:function(C){if(!K(C))throw Error("React.Children.only expected to receive a single React element child.");return C}},et.Component=_,et.Fragment=n,et.Profiler=o,et.PureComponent=A,et.StrictMode=r,et.Suspense=m,et.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=W,et.act=V,et.cloneElement=function(C,O,Y){if(C==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+C+".");var de=E({},C.props),me=C.key,X=C.ref,xe=C._owner;if(O!=null){if(O.ref!==void 0&&(X=O.ref,xe=F.current),O.key!==void 0&&(me=""+O.key),C.type&&C.type.defaultProps)var ye=C.type.defaultProps;for(we in O)b.call(O,we)&&!j.hasOwnProperty(we)&&(de[we]=O[we]===void 0&&ye!==void 0?ye[we]:O[we])}var we=arguments.length-2;if(we===1)de.children=Y;else if(1<we){ye=Array(we);for(var Se=0;Se<we;Se++)ye[Se]=arguments[Se+2];de.children=ye}return{$$typeof:u,type:C.type,key:me,ref:X,props:de,_owner:xe}},et.createContext=function(C){return C={$$typeof:f,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},C.Provider={$$typeof:a,_context:C},C.Consumer=C},et.createElement=M,et.createFactory=function(C){var O=M.bind(null,C);return O.type=C,O},et.createRef=function(){return{current:null}},et.forwardRef=function(C){return{$$typeof:c,render:C}},et.isValidElement=K,et.lazy=function(C){return{$$typeof:v,_payload:{_status:-1,_result:C},_init:ee}},et.memo=function(C,O){return{$$typeof:h,type:C,compare:O===void 0?null:O}},et.startTransition=function(C){var O=G.transition;G.transition={};try{C()}finally{G.transition=O}},et.unstable_act=V,et.useCallback=function(C,O){return te.current.useCallback(C,O)},et.useContext=function(C){return te.current.useContext(C)},et.useDebugValue=function(){},et.useDeferredValue=function(C){return te.current.useDeferredValue(C)},et.useEffect=function(C,O){return te.current.useEffect(C,O)},et.useId=function(){return te.current.useId()},et.useImperativeHandle=function(C,O,Y){return te.current.useImperativeHandle(C,O,Y)},et.useInsertionEffect=function(C,O){return te.current.useInsertionEffect(C,O)},et.useLayoutEffect=function(C,O){return te.current.useLayoutEffect(C,O)},et.useMemo=function(C,O){return te.current.useMemo(C,O)},et.useReducer=function(C,O,Y){return te.current.useReducer(C,O,Y)},et.useRef=function(C){return te.current.useRef(C)},et.useState=function(C){return te.current.useState(C)},et.useSyncExternalStore=function(C,O,Y){return te.current.useSyncExternalStore(C,O,Y)},et.useTransition=function(){return te.current.useTransition()},et.version="18.3.1",et}var mp;function Pf(){return mp||(mp=1,Ic.exports=c0()),Ic.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var xp;function p0(){return xp||(xp=1,(function(u){function e(G,W){var V=G.length;G.push(W);e:for(;0<V;){var C=V-1>>>1,O=G[C];if(0<o(O,W))G[C]=W,G[V]=O,V=C;else break e}}function n(G){return G.length===0?null:G[0]}function r(G){if(G.length===0)return null;var W=G[0],V=G.pop();if(V!==W){G[0]=V;e:for(var C=0,O=G.length,Y=O>>>1;C<Y;){var de=2*(C+1)-1,me=G[de],X=de+1,xe=G[X];if(0>o(me,V))X<O&&0>o(xe,me)?(G[C]=xe,G[X]=V,C=X):(G[C]=me,G[de]=V,C=de);else if(X<O&&0>o(xe,V))G[C]=xe,G[X]=V,C=X;else break e}}return W}function o(G,W){var V=G.sortIndex-W.sortIndex;return V!==0?V:G.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;u.unstable_now=function(){return a.now()}}else{var f=Date,c=f.now();u.unstable_now=function(){return f.now()-c}}var m=[],h=[],v=1,g=null,x=3,S=!1,E=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,T=typeof clearTimeout=="function"?clearTimeout:null,A=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function k(G){for(var W=n(h);W!==null;){if(W.callback===null)r(h);else if(W.startTime<=G)r(h),W.sortIndex=W.expirationTime,e(m,W);else break;W=n(h)}}function L(G){if(y=!1,k(G),!E)if(n(m)!==null)E=!0,ee(b);else{var W=n(h);W!==null&&te(L,W.startTime-G)}}function b(G,W){E=!1,y&&(y=!1,T(M),M=-1),S=!0;var V=x;try{for(k(W),g=n(m);g!==null&&(!(g.expirationTime>W)||G&&!B());){var C=g.callback;if(typeof C=="function"){g.callback=null,x=g.priorityLevel;var O=C(g.expirationTime<=W);W=u.unstable_now(),typeof O=="function"?g.callback=O:g===n(m)&&r(m),k(W)}else r(m);g=n(m)}if(g!==null)var Y=!0;else{var de=n(h);de!==null&&te(L,de.startTime-W),Y=!1}return Y}finally{g=null,x=V,S=!1}}var F=!1,j=null,M=-1,z=5,K=-1;function B(){return!(u.unstable_now()-K<z)}function fe(){if(j!==null){var G=u.unstable_now();K=G;var W=!0;try{W=j(!0,G)}finally{W?se():(F=!1,j=null)}}else F=!1}var se;if(typeof A=="function")se=function(){A(fe)};else if(typeof MessageChannel<"u"){var q=new MessageChannel,ae=q.port2;q.port1.onmessage=fe,se=function(){ae.postMessage(null)}}else se=function(){_(fe,0)};function ee(G){j=G,F||(F=!0,se())}function te(G,W){M=_(function(){G(u.unstable_now())},W)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(G){G.callback=null},u.unstable_continueExecution=function(){E||S||(E=!0,ee(b))},u.unstable_forceFrameRate=function(G){0>G||125<G?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<G?Math.floor(1e3/G):5},u.unstable_getCurrentPriorityLevel=function(){return x},u.unstable_getFirstCallbackNode=function(){return n(m)},u.unstable_next=function(G){switch(x){case 1:case 2:case 3:var W=3;break;default:W=x}var V=x;x=W;try{return G()}finally{x=V}},u.unstable_pauseExecution=function(){},u.unstable_requestPaint=function(){},u.unstable_runWithPriority=function(G,W){switch(G){case 1:case 2:case 3:case 4:case 5:break;default:G=3}var V=x;x=G;try{return W()}finally{x=V}},u.unstable_scheduleCallback=function(G,W,V){var C=u.unstable_now();switch(typeof V=="object"&&V!==null?(V=V.delay,V=typeof V=="number"&&0<V?C+V:C):V=C,G){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=V+O,G={id:v++,callback:W,priorityLevel:G,startTime:V,expirationTime:O,sortIndex:-1},V>C?(G.sortIndex=V,e(h,G),n(m)===null&&G===n(h)&&(y?(T(M),M=-1):y=!0,te(L,V-C))):(G.sortIndex=O,e(m,G),E||S||(E=!0,ee(b))),G},u.unstable_shouldYield=B,u.unstable_wrapCallback=function(G){var W=x;return function(){var V=x;x=W;try{return G.apply(this,arguments)}finally{x=V}}}})(Fc)),Fc}var _p;function m0(){return _p||(_p=1,kc.exports=p0()),kc.exports}/**
 * @license React
...
`,gr={TORUS_SCENE:1,BLOOM_SCENE:2,ENTIRE_SCENE:3},zM={uniforms:{iTime:{value:0},tDiffuse:{value:null},torusTexture:{value:null},bloomTexture:{value:null},haloTexture:{value:null},uBg:{value:$s(hM)},uFlameA:{value:$s(pM)},uFlameB:{value:$s(mM)},uFlameAmt:{value:gM}},vertexShader:`
  ...
  `};function OM(){const u=ue.useRef(null),e=ue.useRef(null);return ue.useEffect(()=>{const n=u.current;if(!n)return;const r=new bg({canvas:n,antialias:!0});r.setPixelRatio(window.devicePixelRatio),r.setSize(window.innerWidth,window.innerHeight),r.shadowMap.enabled=!0,r.shadowMap.type=Ws;const o=new oM;o.background=new ft(0),o.fog=new Vf(0,0,15);const a=new Hn(45,window.innerWidth/window.innerHeight,.1,400);a.position.set(0,7,16),a.layers.enable(gr.TORUS_SCENE),a.layers.enable(gr.BLOOM_SCENE),a.layers.enable(gr.ENTIRE_SCENE),o.add(a);const f=new Wf(4.2,200,600),c=new pn({transparent:!0,depthWrite:!1,blending:Qo,uniforms:{uTime:{value:0},uStream:{value:0},uAppear:{value:0},uColLow:{value:$s(SM)},uColHigh:{value:$s(wM)},uOpacity:{value:MM},uSize:{value:EM},uBrightness:{value:TM},uWaveHeight:{value:qm},uFlow:{value:Xm},uScale:{value:bM},uCursor:{value:new Q},uRepelRadius:{value:NM},uRepelStrength:{value:kM},uActivity:{value:0}},vertexShader:`
      ...
      `}),j=new Bm(b,F);j.frustumCulled=!1,j.layers.enable(gr.ENTIRE_SCENE),o.add(j);let M=0,z=0,K=0;const B={x:0,y:0},fe={x:0,y:0},se={world:new Q,activity:0,active:!1,lastMove:performance.now()},q=new Q,ae=new Q,ee=new Q;function te(){if(ee.set(0,0,0),se.active){q.set(fe.x,fe.y,.5).unproject(a),ae.copy(q).sub(a.position).normalize();const ye=ae.z;if(Math.abs(ye)>1e-4){const we=-a.position.z/ye;we>0&&Number.isFinite(we)&&ee.copy(a.position).addScaledVector(ae,we)}}se.world.lerp(ee,.12);const xe=(performance.now()-se.lastMove)/1e3;se.activity+=((se.active&&xe<3?1:0)-se.activity)*.06}const G=()=>{const xe=document.documentElement.scrollHeight-window.innerHeight;M=xe>0?$m(window.scrollY/xe,0,1):0},W=xe=>{B.x=xe.clientX/window.innerWidth*2-1,B.y=-(xe.clientY/window.innerHeight*2-1),se.active=!0,se.lastMove=performance.now()},V=()=>{se.active=!1};window.addEventListener("scroll",G,{passive:!0}),window.addEventListener("mousemove",W,{passive:!0}),window.addEventListener("mouseout",V);let C=0;const O=performance.now();let Y=performance.now()/1e3,de=!0;function me(){if(!de)return;requestAnimationFrame(me);const xe=performance.now()/1e3,ye=Math.min(.05,xe-Y);Y=xe,z=mr(z,M,.1),K=mr(K,z,.06),fe.x=mr(fe.x,B.x,.06),fe.y=mr(fe.y,B.y,.06),c.uniforms.uTime.value=xe,C+=ye*(Xm*2)*4,c.uniforms.uStream.value=C,c.uniforms.uWaveHeight.value=qm*(1+K*CM);const we=Math.min(K/.35,1),Se=we*we*(3-2*we),je=mr(AM,LM,Se),Ge=mr(RM,PM,Se);a.position.set(fe.x*yf,je+fe.y*yf*.3,Ge),a.lookAt(fe.x*yf*.5,mr(0,.6,Se),mr(DM,IM,Se)),h.rotation.x=-0,h.rotation.y=0,te(),c.uniforms.uCursor.value.copy(se.world),c.uniforms.uActivity.value=se.activity;const Ie=(performance.now()-O)/1e3;c.uniforms.uAppear.value=Math.max(0,Math.min(1,(Ie-.2)/1.4)),F.uniforms.uTime.value=xe*yM*8,j.position.copy(a.position),S.uniforms.iTime.value=xe,a.layers.set(gr.TORUS_SCENE),g.render(),a.layers.set(gr.BLOOM_SCENE),x.render(),a.layers.set(gr.ENTIRE_SCENE),_.render()}const X=()=>{const xe=window.innerWidth,ye=window.innerHeight,we=window.devicePixelRatio;r.setPixelRatio(we),r.setSize(xe,ye,!1),a.aspect=xe/ye,a.updateProjectionMatrix(),g.setPixelRatio(we),g.setSize(xe,ye),x.setPixelRatio(we),x.setSize(xe,ye),_.setPixelRatio(we),_.setSize(xe,ye),F.uniforms.uRes.value.set(xe*we,ye*we);const Se=document.documentElement.scrollHeight-window.innerHeight;M=Se>0?$m(window.scrollY/Se,0,1):0};return window.addEventListener("resize",X),X(),me(),e.current=()=>{de=!1,window.removeEventListener("scroll",G),window.removeEventListener("mousemove",W),window.removeEventListener("mouseout",V),window.removeEventListener("resize",X),f.dispose(),c.dispose(),b.dispose(),F.dispose(),y.dispose(),r.dispose()},()=>{e.current&&e.current()}},[]),D.jsx("canvas",{ref:u,id:"flow-wave-canvas",style:{position:"fixed",inset:0,width:"100vw",height:"100vh",display:"block",zIndex:0,pointerEvents:"auto"}})}function UM(u){const[e,n]=ue.useState("connecting"),r=ue.useRef(null),o=ue.useRef(u),a=ue.useRef(null),f=ue.useRef(!1);ue.useEffect(()=>{o.current=u},[u]);const c=ue.useCallback(()=>{if(f.current)return;const h=A0();n("connecting");const v=new WebSocket(h);r.current=v,v.onopen=()=>{n("connected")},v.onmessage=g=>{try{const x=JSON.parse(g.data);o.current&&o.current(x)}catch(x){console.error("WebSocket message parse error:",x)}},v.onclose=()=>{n("disconnected"),f.current||(a.current=setTimeout(()=>{a.current=null,c()},2500))},v.onerror=()=>{v.close()}},[]);ue.useEffect(()=>(f.current=!1,c(),()=>{f.current=!0,a.current&&(clearTimeout(a.current),a.current=null),r.current&&(r.current.close(),r.current=null)}),[c]);const m=ue.useCallback((h,v={})=>{r.current&&r.current.readyState===WebSocket.OPEN&&r.current.send(JSON.stringify({command:h,...v}))},[]);return{connectionStatus:e,sendCommand:m}}function BM({sendCommand:u,connectionStatus:e}={}){const[n,r]=ue.useState(!1),[o,a]=ue.useState("Ready"),[f,c]=ue.useState([]),[m,h]=ue.useState(null),[v,g]=ue.useState("00:00"),[x,S]=ue.useState("idle"),E=ue.useRef(null),y=ue.useRef([]),_=ue.useRef(null),T=ue.useRef(null),A=ue.useRef(null),k=ue.useRef(0),L=ue.useRef(null),b=ue.useRef(!1),F=ue.useRef(null),j=ue.useRef(!1),M=ue.useRef(0),z=ue.useRef({}),K=ue.useRef(u),B=ue.useRef([]);ue.useEffect(()=>{B.current=f},[f]);const fe=async(C,O)=>{try{await fetch(Nt(`/api/visits/${C}/transcript`),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({segment_id:O.segment_id,text:O.text,sequence:O.sequence,timestamp:O.timestamp,speaker:O.speaker})})}catch(Y){console.warn("Failed to persist transcript segment:",Y)}},se=ue.useCallback(C=>{L.current&&C.visit_id&&C.visit_id!==L.current||(C.type==="transcript_partial"?(h({segment_id:C.segment_id,text:C.text,speaker:C.speaker||"Speaker",timestamp:C.timestamp,sequence:C.sequence}),S("processing")):C.type==="transcript_final"&&(h(null),S("listening"),c(O=>O.some(Y=>Y.segment_id===C.segment_id)?O.map(Y=>Y.segment_id===C.segment_id?C:Y):[...O,C])))},[]),q=ue.useCallback(()=>{if(b.current=!1,j.current=!1,A.current&&(clearInterval(A.current),A.current=null),F.current){try{F.current.onstart=null,F.current.onresult=null,F.current.onerror=null,F.current.onend=null,F.current.abort()}catch{}F.current=null}if(E.current&&E.current.state!=="inactive")try{E.current.stop()}catch{}_.current&&(_.current.getTracks().forEach(C=>C.stop()),_.current=null),r(!1),S("idle"),h(null)},[]),ae=ue.useCallback(async({name:C,visitId:O,language:Y="en-US",sendCommand:de}={})=>{if(b.current)return;de&&(K.current=de);const me=O||`visit-${Date.now()}`;if(L.current=me,!navigator.mediaDevices||!navigator.mediaDevices.getUserMedia){a("Audio capture not supported in this browser."),S("denied");return}try{const X=await navigator.mediaDevices.getUserMedia({audio:!0});_.current=X;const xe=new MediaRecorder(X);E.current=xe,y.current=[],T.current=new Date().toISOString(),b.current=!0,r(!0),S("listening"),a(`Listening to live speech — ${C||"Visitor"} is active.`);let ye=[];xe.ondataavailable=Se=>{Se.data.size>0&&(y.current.push(Se.data),ye.push(Se.data))},xe.start(1e3),A.current=setInterval(async()=>{if(!b.current)return;if(Date.now()-k.current>4e3&&ye.length>0){const Ge=new Blob(ye,{type:xe.mimeType||"audio/webm"});if(ye=[],Ge.size>1500)try{const Ie=await fetch(Nt("/api/transcribe"),{method:"POST",headers:{"Content-Type":Ge.type||"audio/webm"},body:Ge});if(Ie.ok){const dt=await Ie.json();if(dt.success&&dt.transcript&&dt.transcript.trim()){const kt=dt.transcript.trim(),xt=M.current++,Lt={type:"transcript_final",visit_id:me,segment_id:`${me}-whisper-${xt}`,text:kt,is_final:!0,speaker:"Speaker",sequence:xt,timestamp:new Date().toISOString()};se(Lt),fe(me,Lt);const ht=K.current||u;ht&&ht("broadcast_transcript",Lt)}}}catch(Ie){console.warn("Whisper fallback slice error:",Ie)}}else ye=[]},4500);const we=window.SpeechRecognition||window.webkitSpeechRecognition||null;if(we){const Se=()=>{if(b.current)try{if(F.current)try{F.current.onstart=null,F.current.onresult=null,F.current.onerror=null,F.current.onend=null,F.current.abort()}catch{}const je=new we;je.continuous=!0,je.interimResults=!0,je.lang=Y,F.current=je,j.current=!0,je.onstart=()=>{S("listening")},je.onresult=Ge=>{k.current=Date.now(),S("processing");for(let Ie=Ge.resultIndex;Ie<Ge.results.length;Ie++){const dt=Ge.results[Ie],kt=dt[0].transcript.trim();if(!kt)continue;const xt=`${me}-${Ie}`,Lt=dt.isFinal,ht={type:Lt?"transcript_final":"transcript_partial",visit_id:me,segment_id:xt,text:kt,is_final:Lt,speaker:"Speaker",sequence:Ie,timestamp:new Date().toISOString()};Lt?(h(null),c(Bt=>Bt.some(Pt=>Pt.segment_id===xt)?Bt.map(Pt=>Pt.segment_id===xt?ht:Pt):[...Bt,ht]),S("listening"),fe(me,ht)):h(ht);const rt=K.current||u;rt&&rt("broadcast_transcript",ht)}},je.onend=()=>{b.current&&j.current&&setTimeout(()=>{b.current&&j.current&&Se()},250)},je.onerror=Ge=>{Ge.error==="not-allowed"&&(S("denied"),a("Microphone permission required"))},je.start()}catch(je){console.warn("SpeechRecognition start exception:",je)}};Se()}}catch(X){r(!1),S("denied"),a(`Could not start audio capture: ${X.message}`)}},[u,se]),ee=ue.useCallback(C=>E.current?(a("Visit ended — summarizing memory with Groq..."),new Promise(O=>{E.current.onstop=async()=>{const Y=new Blob(y.current,{type:"audio/webm"});y.current=[];const me=(B.current||[]).map(X=>`${X.speaker}: ${X.text}`).join(`
`);if(Y.size>100){const X=new FormData;X.append("audio",Y,"visit_audio.webm"),X.append("person_id",(C==null?void 0:C.person_id)||"unknown"),X.append("started_at",T.current||new Date().toISOString()),X.append("ended_at",new Date().toISOString()),X.append("visit_id",L.current||""),fetch(Nt("/api/visits/audio"),{method:"POST",body:X}).catch(xe=>console.warn("Background audio upload warning:",xe))}if(me&&me.trim().length>6)try{const X=await nx(C,me);if(X&&X.trim()&&!X.toLowerCase().includes("processing")){a(`Memory summarized: "${X}"`),O(X.trim());return}}catch(X){console.warn("Groq visit summarization failed:",X)}O(null)},q()})):Promise.resolve(null),[q]),te=ue.useCallback((C,O)=>{if(!C||!C.trim())return;L.current||(L.current=`session-${Date.now()}`);const Y=L.current;O&&(K.current=O);let de="Speaker",me=C.trim();const X=C.indexOf(":");X>0&&X<20&&(de=C.substring(0,X).trim(),me=C.substring(X+1).trim());const xe=M.current++,ye=`${Y}-manual-${xe}-${Date.now()}`,we={type:"transcript_final",visit_id:Y,segment_id:ye,text:me,is_final:!0,speaker:de,sequence:xe,timestamp:new Date().toISOString()};c(je=>[...je,we]),S("listening");const Se=K.current||u;Se&&Se("broadcast_transcript",we),fe(Y,we)},[u]),G=ue.useCallback(()=>{c([]),h(null),z.current={},M.current=0},[]),W=ue.useCallback(C=>{C&&(L.current=C,fetch(Nt(`/api/visits/${C}/transcript`)).then(O=>O.json()).then(O=>{if(O&&O.success&&O.segments){c(O.segments);const Y=O.segments.reduce((de,me)=>Math.max(de,me.sequence),-1);M.current=Y+1}}).catch(O=>console.warn("Error catching up on segments:",O)))},[]);ue.useEffect(()=>{if(!n||!T.current){g("00:00");return}const C=setInterval(()=>{const O=Date.now()-new Date(T.current).getTime(),Y=Math.max(0,Math.floor(O/1e3)),de=String(Math.floor(Y/60)).padStart(2,"0"),me=String(Y%60).padStart(2,"0");g(`${de}:${me}`)},1e3);return()=>clearInterval(C)},[n]),ue.useEffect(()=>()=>{q()},[q]);const V=f.map(C=>`${C.speaker}: ${C.text}`).join(`
`);return{isCapturing:n,transcript:V,statusMessage:o,startCapture:ae,stopListening:q,stopCaptureAndSummarize:ee,appendTranscript:te,resetTranscript:G,liveSegments:f,partialSegment:m,visitDuration:v,statusState:x,handleLiveTranscriptEvent:se,catchUpTranscript:W,setStatusState:S}}function GM(){const[u,e]=ue.useState([]),[n,r]=ue.useState(!0),o=ue.useCallback(async()=>{try{const v=await fetch(Nt("/api/roster"));if(!v.ok)throw new Error("Failed to fetch roster");const g=await v.json();e(g)}catch(v){console.error("Roster fetch error:",v)}finally{r(!1)}},[]);ue.useEffect(()=>{o()},[o]);const a=ue.useCallback(async v=>{if(!(await fetch(Nt("/api/roster"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(v)})).ok)throw new Error("Failed to create profile");await o()},[o]),f=ue.useCallback(async v=>{if(!(await fetch(Nt(`/api/roster/${v}`),{method:"DELETE"})).ok)throw new Error("Failed to delete profile");await o()},[o]),c=ue.useCallback(async(v,g=null)=>{const S=await(await fetch(Nt("/api/register_face"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({person_id:v,image_base64:g})})).json();return S.success&&await o(),S},[o]),m=ue.useCallback(async v=>{const g=await fetch(Nt(`/api/clear_encodings/${v}`),{method:"POST"}),x=await g.json();return g.ok&&await o(),x},[o]),h=ue.useCallback(async(v,g,x="")=>{try{(await fetch(Nt("/api/update_note"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({person_id:v,note:g,transcript:x})})).ok&&await o()}catch(S){console.error("Failed to save memory note:",S)}},[o]);return{profiles:u,loading:n,reload:o,addProfile:a,deleteProfile:f,registerFace:c,clearFaceEncodings:m,saveUpdatedNote:h}}function VM(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(u){const e=Math.random()*16|0;return(u==="x"?e:e&3|8).toString(16)})}const WM={ttsEnabled:!0,interactionEnabled:!0,autoListenEnabled:!0,rate:.85,pitch:1,volume:1,language:"en-US",voiceName:null};function HM(){const[u,e]=ue.useState("patient"),[n,r]=ue.useState(null),o=ue.useRef(null),[a,f]=ue.useState(null),[c,m]=ue.useState(WM),h=ue.useRef(null),{profiles:v,addProfile:g,deleteProfile:x,registerFace:S,clearFaceEncodings:E,saveUpdatedNote:y,reload:_}=GM(),{isCapturing:T,transcript:A,startCapture:k,stopListening:L,stopCaptureAndSummarize:b,appendTranscript:F,resetTranscript:j,liveSegments:M,partialSegment:z,visitDuration:K,statusState:B,handleLiveTranscriptEvent:fe,catchUpTranscript:se,setStatusState:q}=BM(),ae=ue.useCallback(Y=>{const de=v.find(X=>X.person_id===Y.person_id)||Y;o.current=de,r(de),j();const me=VM();f(me),k({name:de.name,visitId:me,language:c.language,sendCommand:h.current})},[v,j,k,c.language]),ee=ue.useCallback(async()=>{const Y=o.current;if(!Y)return;o.current=null,r(null),f(null);const de=await b(Y);de&&await y(Y.person_id,de,A)},[b,y,A]),te=ue.useCallback(Y=>{switch(Y.type){case"recognized":ae(Y.person);break;case"unrecognized":ee();break;case"memory_updated":_();break;case"transcript_partial":case"transcript_final":fe(Y);break}},[ae,ee,_,fe]),{connectionStatus:G,sendCommand:W}=UM(te);h.current=W,ue.useEffect(()=>{G==="disconnected"?q("disconnected"):G==="connected"&&q(T?"listening":"idle")},[G,T,q]),ue.useEffect(()=>{G==="connected"&&a&&se(a)},[G,a,se]);const V=async Y=>{try{await fetch(Nt("/api/simulate"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"arrive",person_id:Y})})}catch(de){console.error("Simulation error:",de)}},C=async()=>{try{await fetch(Nt("/api/simulate"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"leave"})})}catch(Y){console.error("Simulation error:",Y)}},O=async()=>{o.current&&await ee()};return D.jsxs(D.Fragment,{children:[D.jsx(OM,{}),D.jsxs("header",{className:"top-nav",children:[D.jsxs("div",{className:"brand-wrapper",children:[D.jsx("div",{className:"brand-icon",children:"⚓"}),D.jsxs("div",{className:"brand-text",children:[D.jsx("h1",{children:"Anchor"}),D.jsx("p",{children:"Dementia Care Companion"})]})]}),D.jsxs("div",{className:"nav-controls",children:[D.jsxs("div",{className:"status-pill",children:[D.jsx("span",{className:`status-dot ${G==="connected"?"active":G==="connecting"?"idle":"warn"}`}),D.jsx("span",{children:G==="connected"?"Live Connected":G==="connecting"?"Connecting...":"Disconnected"})]}),D.jsxs("div",{className:"mode-tab-group",children:[D.jsx("button",{className:`mode-tab ${u==="patient"?"active":""}`,onClick:()=>e("patient"),children:"Patient View"}),D.jsx("button",{className:`mode-tab ${u==="caregiver"?"active":""}`,onClick:()=>e("caregiver"),children:"Caregiver & Controls"})]})]})]}),D.jsx("main",{className:"app-container",children:u==="patient"?D.jsx(H0,{recognizedPerson:n,speakAloud:c.ttsEnabled,ttsSettings:c,interactionEnabled:c.interactionEnabled,autoListenEnabled:c.autoListenEnabled}):D.jsx(fx,{isVisitorPresent:!!n,activePerson:n,transcript:A,isCapturing:T,onToggleListening:()=>{T?L():k({name:(n==null?void 0:n.name)||"Caregiver/Visitor",language:c.language,sendCommand:h.current})},onAppendSpeech:Y=>F(Y,h.current),onClearSpeech:j,onSimulateArrive:V,onSimulateLeave:C,onForceSummarize:O,profiles:v,onAddPerson:g,onDeletePerson:x,onRegisterFace:S,onClearEncodings:E,ttsSettings:c,onTtsSettingsChange:m,liveSegments:M,partialSegment:z,visitDuration:K,statusState:B})})]})}const jM=y0.createRoot(document.getElementById("root"));jM.render(D.jsx(h0.StrictMode,{children:D.jsx(HM,{})}));
